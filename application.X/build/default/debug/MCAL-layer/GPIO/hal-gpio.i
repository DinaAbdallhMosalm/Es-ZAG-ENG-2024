...
# 2 "<built-in>" 2
# 1 "MCAL-layer/GPIO/hal-gpio.c" 2
...
# 1 "MCAL-layer/GPIO/hal-gpio.h" 1
# 13 "MCAL-layer/GPIO/hal-gpio.h"
...
# 13 "MCAL-layer/GPIO/hal-gpio.h" 2

# 1 "MCAL-layer/GPIO/../mcal-std-types.h" 1
# 14 "MCAL-layer/GPIO/../mcal-std-types.h"
# 1 "MCAL-layer/GPIO/../std-libraries.h" 1
# 13 "MCAL-layer/GPIO/../std-libraries.h"
...
# 13 "MCAL-layer/GPIO/../std-libraries.h" 2
# 14 "MCAL-layer/GPIO/../mcal-std-types.h" 2

# 1 "MCAL-layer/GPIO/../compilor.h" 1
# 15 "MCAL-layer/GPIO/../mcal-std-types.h" 2
# 30 "MCAL-layer/GPIO/../mcal-std-types.h"
typedef unsigned char uint8 ;

typedef uint8 Std_ReturnType ;
# 14 "MCAL-layer/GPIO/hal-gpio.h" 2

# 1 "MCAL-layer/GPIO/../device-config.h" 1
# 15 "MCAL-layer/GPIO/hal-gpio.h" 2

# 1 "MCAL-layer/GPIO/hal-gpio-cfg.h" 1
# 16 "MCAL-layer/GPIO/hal-gpio.h" 2
# 34 "MCAL-layer/GPIO/hal-gpio.h"
typedef enum {
   GPIO_LOW = 0,
    GPIO_HIGH ,
}logic_t;
...
# 7 "MCAL-layer/GPIO/hal-gpio.c" 2
...
Std_ReturnType gpio_pin_read_logic (const pin_config_t *_pin_config, logic_t *logic){
    ...
    ret = (Std_ReturnType)0x00;
         ...
         *logic = ((*lat_registers[_pin_config -> port] >> _pin_config -> pin)& (uint8)1);
    }
      return ret ;
}
...
# 136 "MCAL-layer/GPIO/hal-gpio.c"
Std_ReturnType gpio_port_direction_initialize (port_index_t port , uint8 direction){
    Std_ReturnType ret = (Std_ReturnType)0x01 ;
